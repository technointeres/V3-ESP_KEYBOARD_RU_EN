...
void CHATS() {
  PressedButton(0); 
        ...
        charColo = TFT_BLACK;
        MyText = "Чаты:";       startX = 88; startY = 0;   scaleX = 1; scaleY = 1; event(); 
        MyText = "Управление:"; startX = 50; startY = 110; scaleX = 1; scaleY = 1; event();
        charColo = TFT_WHITE;
//Чаты:         
...
void BLUETOOTHAPPS() { 
  ...
  if(!Keyboard.isConnected()) {Keyboard.begin(); Mouse.begin();}
   ...
   startX = 2; startY = 190; MyText = ""; charColo = color565(250,170,190); event();//PINK //
